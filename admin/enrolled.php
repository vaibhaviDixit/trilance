...
$sql="select enrolled.*,batches.name as batchName from enrolled,batches where batches.id=enrolled.batchId order by enrolled.id desc";
...
?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Enrolled Students For Batches</h1>
					</div>
					<hr>
