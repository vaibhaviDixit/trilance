<?php
 ...
 if(isset($_GET['id']) && $_GET['id']>0){
    $batchId=$_GET['id'];
    $batch=mysqli_query($con,"select * from batches where id='$batchId' ");
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" id="enrollform">
                        ...
                        <div>
                            <input type="submit" name="enroll" class="btn btn--radius-2 btn--red" value="Enroll Now" id="submitEnroll">
                        </div>
                    </form>
                </div>
            </div>
